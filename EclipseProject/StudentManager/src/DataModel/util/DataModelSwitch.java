...
public class DataModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case DataModelPackage.STUDENT_COLLECTION: {
				StudentCollection studentCollection = (StudentCollection)theEObject;
				T result = caseStudentCollection(studentCollection);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case DataModelPackage.STUDENT: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Student Collection</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Student Collection</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseStudentCollection(StudentCollection object) {
		return null;
	}
