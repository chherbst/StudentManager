...
public class DataModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected DataModelSwitch<Adapter> modelSwitch =
		new DataModelSwitch<Adapter>() {
			@Override
			public Adapter caseStudentCollection(StudentCollection object) {
				return createStudentCollectionAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link DataModel.StudentCollection <em>Student Collection</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createStudentCollectionAdapter() {
		return null;
	}

	/**
	 * Creates a new adapter for an object of class '{@link DataModel.Student <em>Student</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
